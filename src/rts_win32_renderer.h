...
#define WIN32_LOAD_RENDERER(name) Platform_Renderer *name(HDC window_dc, u64 push_buffer_size, struct Arena *renderer_arena, OS_State *os_init)
...
read_only char *win32_renderer_function_table_names[] = 
{
    "win32_load_renderer",
    "win32_begin_frame",
    "win32_end_frame",
