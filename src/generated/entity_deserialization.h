...
{
    Camera *e = push_entity(parser->game_state->world, Camera, {});
...
{
    Crate *e = push_entity(parser->game_state->world, Crate, {});
...
{
    Ground *e = push_entity(parser->game_state->world, Ground, {});
...
{
    Rock *e = push_entity(parser->game_state->world, Rock, {});
...
{
    Xbot *e = push_entity(parser->game_state->world, Xbot, {});
