...
dwrite_runs_from_string(Utf8 string, Utf8 base_family8, f32 font_size)
{
    ...
    while (offset < string16.len)
    {
        ...
        if (font == NULL)
        {
            ...
            font->atlas.id = render_texture_create(RENDER_TEXTURE_TYPE_R8G8B8A8, font->atlas.data, font->atlas.width, font->atlas.height, RENDER_COMMAND_FLAG_TEXTURE_FILTER_DOT);
        }
